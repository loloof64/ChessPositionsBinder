...
class _TranslationsWidgetsCommanderCompressItemsEs implements TranslationsWidgetsCommanderCompressItemsEn {
	_TranslationsWidgetsCommanderCompressItemsEs._(this._root);
...
class _TranslationsPagesPhotoOcrButtonsEs implements TranslationsPagesPhotoOcrButtonsEn {
	...
	@override String get use_it => 'Utilizar';
}
...
class _TranslationsPagesDropboxConfirmUploadFilesEs implements TranslationsPagesDropboxConfirmUploadFilesEn {
	_TranslationsPagesDropboxConfirmUploadFilesEs._(this._root);
...
extension on TranslationsEs {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'pages.photo_ocr.buttons.use_it': return 'Utilizar';
