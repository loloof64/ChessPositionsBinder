...
class _TranslationsPagesPositionDetailsEs implements TranslationsPagesPositionDetailsEn {
	...
	// Translations
	@override String get title => 'Detalles de la posición';
}
...
class _TranslationsPagesPositionEditorEs implements TranslationsPagesPositionEditorEn {
	...
	// Translations
	@override String get title => 'Editor de posición';
...
extension on TranslationsEs {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'pages.position_details.title': return 'Detalles de la posición';
			case 'pages.position_editor.title': return 'Editor de posición';
